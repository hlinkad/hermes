...
def context(req: ContextRequest, _=Security(verify_key)):
    """Retrieval-only compact context for Hermes pre_llm_call hooks."""
    return {"context": build_context_for_prompt(req.prompt, settings)}
